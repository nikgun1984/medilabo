...
const FIELD = 'border border-gray-300 rounded-md px-3 py-2 w-full text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400'
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input className={FIELD} {...register('lastName', { required: 'Last name is required' })} />
          {errors.lastName && <p className={ERR}>{errors.lastName.message}</p>}
        </div>
        <div>
          <label className={LABEL}>First Name *</label>
          <input className={FIELD} {...register('firstName', { required: 'First name is required' })} />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input type="date" className={FIELD} {...register('dateOfBirth', { required: 'Date of birth is required' })} />
